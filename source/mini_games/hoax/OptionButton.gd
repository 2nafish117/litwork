...
func set_option_label(val: String):
	option_label = val
	if has_node("MarginContainer/HBoxContainer/OptionLabel"):
		$MarginContainer/HBoxContainer/OptionLabel.text = val
...
func set_option_text(val: String):
	option_text = val
	if has_node("MarginContainer/HBoxContainer/OptionText"):
		$MarginContainer/HBoxContainer/OptionText.text = val
